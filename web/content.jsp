...
<section class="main-container col2-left-layout">
		...
		<div class="block block-sample row clearfix">
						...
						<div class="slider-home"><a href="#"><img alt="" src="img/slider01.jpg" /></a>
<div class="slider-content">
<p class="text02">Collection of Channel</p>
<p class="title02">NEW ARRIVAL</p>
<p class="text03">Discovery the best collection of<br />Channel with perfect design<br />on all product</p>
<a class="btn-shopnow"><span>Shop now </span></a></div>
</div>					</div>
									<div class="col-lg-12  col-md-12  col-sm-12  col-xs-12  ">
						<div class="slider-home"><a href="#"><img alt="" src="img/slider01.jpg" /></a>
<div class="slider-content">
...
<h2>Home Page</h2>
    ...
    <div class="main-heading">
        ...
        <ul class="products-grid  owl-carousel">
            ...
            <div class="item-inner">
                ...
                <span class="amount"><a href="#" onclick="var t = opener ? opener.window : window; t.location.href='http://mt-quartz02.magentothemes.net/index.php/simple-product.html'; return false;">1 Review(s)</a></span>
    </div>
                                </div>
    ...
    <div class="price-box">
        ...
        <span class="price" id="product-minimal-price-25">
            ...
            <div class="item-inner">
                ...
                <span class="amount"><a href="#" onclick="var t = opener ? opener.window : window; t.location.href='http://mt-quartz02.magentothemes.net/index.php/strip-blazer.html'; return false;">1 Review(s)</a></span>
    </div>
                                </div>
    ...
    <div class="price-box">
            ...
            <div class="item-inner">
                ...
                <span class="amount"><a href="#" onclick="var t = opener ? opener.window : window; t.location.href='http://mt-quartz02.magentothemes.net/index.php/brown-sungglasses.html'; return false;">1 Review(s)</a></span>
    </div>
                                </div>
    ...
    <div class="price-box">
            ...
            <div class="item-inner">
                ...
                <span class="amount"><a href="#" onclick="var t = opener ? opener.window : window; t.location.href='http://mt-quartz02.magentothemes.net/index.php/partern-blazer.html'; return false;">3 Review(s)</a></span>
    </div>
                                </div>
    ...
    <div class="price-box">
            ...
            <div class="item-inner">
                ...
                <span class="amount"><a href="#" onclick="var t = opener ? opener.window : window; t.location.href='http://mt-quartz02.magentothemes.net/index.php/leo-sungglasses.html'; return false;">1 Review(s)</a></span>
    </div>
                                </div>
    ...
    <div class="price-box">
            ...
            <div class="item-inner">
                ...
                <span class="amount"><a href="#" onclick="var t = opener ? opener.window : window; t.location.href='http://mt-quartz02.magentothemes.net/index.php/print-sneaker.html'; return false;">2 Review(s)</a></span>
    </div>
                                </div>
    ...
    <div class="price-box">
        ...
        <span class="price" id="product-minimal-price-19">
            ...
            <div class="item-inner">
                ...
                <span class="amount"><a href="#" onclick="var t = opener ? opener.window : window; t.location.href='http://mt-quartz02.magentothemes.net/index.php/square-sungglasses.html'; return false;">1 Review(s)</a></span>
    </div>
                                </div>
    ...
    <div class="price-box">
            ...
            <div class="item-inner">
                ...
                <span class="amount"><a href="#" onclick="var t = opener ? opener.window : window; t.location.href='http://mt-quartz02.magentothemes.net/index.php/blazer-with-flap-pocket.html'; return false;">1 Review(s)</a></span>
    </div>
                                </div>
    ...
    <div class="price-box">
            ...
            <div class="item-inner">
                ...
                <span class="amount"><a href="#" onclick="var t = opener ? opener.window : window; t.location.href='http://mt-quartz02.magentothemes.net/index.php/urban-butcher.html'; return false;">1 Review(s)</a></span>
    </div>
                                </div>
    ...
    <div class="price-box">
        ...
        <span class="price" id="product-minimal-price-18">
            ...
            <div class="item-inner">
                ...
                <span class="amount"><a href="#" onclick="var t = opener ? opener.window : window; t.location.href='http://mt-quartz02.magentothemes.net/index.php/combine-oxford-shoes.html'; return false;">1 Review(s)</a></span>
    </div>
                                </div>
