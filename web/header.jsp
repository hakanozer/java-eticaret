		...
		<ul id="mtnav" class="megamenu">
				...
				<a href="http://mt-quartz02.magentothemes.net/index.php/" class="level-top"><span>Home</span></a>
						...
						<li class="level0 level-top parent custom-block menu-item-features">
							...
							<div class="sub-wrapper"><div class="row static-home">
<div class="col-lg-4 col-xs-4">
<h4>HEADER STYLE</h4>
<ul>
<li><a href="http://mt-quartz01.magentothemes.net/index.php/">Home Layout 1</a></li>
<li><a href="http://mt-quartz02.magentothemes.net/index.php/">Home Layout 2</a></li>
<li><a href="http://mt-quartz03.magentothemes.net/index.php/">Home Layout 3</a></li>
<li><a href="http://mt-quartz04.magentothemes.net/index.php/">Home Layout 4</a></li>
<li><a href="http://mt-quartz05.magentothemes.net/index.php/">Home Layout 5</a></li>
</ul>
</div>
<div class="col-lg-4 col-xs-4">
<h4>COLOR STYLE</h4>
<ul class="color-style">
<li><a href="http://mt-quartz02.magentothemes.net/index.php/?___store=default"><span class="orange home-layout">&nbsp;</span><span>Orange</span></a></li>
<li><a href="http://mt-quartz02.magentothemes.net/index.php/?___store=french"><span class="blue home-layout">&nbsp;</span><span>Blue</span></a></li>
<li><a href="http://mt-quartz02.magentothemes.net/index.php/?___store=german"><span class="green home-layout">&nbsp;</span><span>Green</span></a></li>
<li><a href="http://mt-quartz02.magentothemes.net/index.php/?___store=spanish"><span class="red home-layout">&nbsp;</span><span>Red</span></a></li>
</ul>
</div>
<div class="col-lg-4 col-xs-4">
<h4>PRODUCT TYPE</h4>
<ul>
<li><span class="widget widget-product-link"><a href="http://mt-quartz02.magentothemes.net/index.php/simple-product.html?___store=default" title="Simple Product"><span>Simple Product</span></a></span>
</li>
<li><span class="widget widget-product-link"><a href="http://mt-quartz02.magentothemes.net/index.php/blazer-with-flap-pocket.html?___store=default" title="Configuration Product"><span>Configuration Product</span></a></span>
</li>
<li><span class="widget widget-product-link"><a href="http://mt-quartz02.magentothemes.net/index.php/pique-blazer.html?___store=default" title="Group Product"><span>Group Product</span></a></span>
</li>
<li><span class="widget widget-product-link"><a href="http://mt-quartz02.magentothemes.net/index.php/related-product.html?___store=default" title="Related Product"><span>Related Product</span></a></span>
</li>
<li><span class="widget widget-product-link"><a href="http://mt-quartz02.magentothemes.net/index.php/upsell-product.html?___store=default" title="Upsell Product"><span>Upsell Product</span></a></span>
</li>
</ul>
</div>
</div></div>
					...
					<li class="level0 level-top parent custom-block  menu-item-right">
						<a href="http://mt-quartz02.magentothemes.net/index.php/about-us" class="level-top">
							<span>About Us</span>
						</a> 
					</li> 
				 
					<li class="level0 level-top parent custom-block  menu-item-right">
						<a href="http://mt-quartz02.magentothemes.net/index.php/blog" class="level-top">
							<span>Blog</span>
						</a> 
					</li> 
				 
					<li class="level0 level-top parent custom-block  menu-item-right">
						<a href="http://mt-quartz02.magentothemes.net/index.php/contact" class="level-top">
							<span>Contact</span>
						</a> 
					</li> 
						</ul>
    ...
    <div class="maincompare">
        ...
        <div class="mt-cart">
            <div class="mt-icon-ajaxcart">
               <div class="mt-icon icon-cart second_primary_color_bg">
                    <i aria-hidden="true" class="icon_bag_alt"></i>
                </div>
                <a class="mt-cart-label primary_color_bg" href="http://mt-quartz02.magentothemes.net/index.php/checkout/cart/">
                    <span class="print">
