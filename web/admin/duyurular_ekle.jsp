                ...
                <section>
                    ...
                    <div class="panel panel-primary" style="width: 75%; margin: 0 auto; margin-bottom: 50px">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title text-center">Duyuru Ekleme</h4>
                        </div>

                        <div class="panel-body">

                            <p class="text-center">Yeni Duyuru Ekle</p>
                            <hr>
                            <form class="form-horizontal" action="duyurular_ekle_action.jsp" method="post" style="width: 90%; margin: 0 auto;">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" required id="baslik" name="duyuru_baslik" value="" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="duyuru_detay" id="detay" cols="30" rows="10" class="form-control"></textarea>
                                            <script>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="durum_id" id="durum">
                                ...
                                <div class="form-group" >
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 text-right">
                                            ...
                                            <a class="btn btn-danger" href="duyurular.jsp">İptal</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
