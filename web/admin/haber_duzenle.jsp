        ...
        <div id="page-wrapper">
            ...
            <content style="padding: 40px 0px">
                ...
                <div class="text-right" style="margin-bottom: 25px">
                        <a href="haberler.jsp" class="btn btn-primary"><i class="glyphicon glyphicon-backward"> </i> Geri Dön</a>
                    </div>
                ...
                <section>
                    ...
                    <%
                        ...
                        if (!dDurum) {
                            ...
                            try {
                                rss = ns.baglan().executeQuery("select *from haberler where id = '" + aid + "' ");
                                rss.next();
                            } catch (Exception ex) {
                    ...
                    <div class="panel panel-primary" style="width: 75%; margin: 0 auto; margin-bottom: 50px">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="text-center">Haber Düzenleme</p>
                            <hr>
                            <form class="form-horizontal" action="haber_duzenle_action.jsp" method="post" style="width: 90%; margin: 0 auto;">
                                ...
                                <div class="form-group" >
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 text-right">
                                            ...
                                            <a class="btn btn-danger" href="haberler.jsp">İptal</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
