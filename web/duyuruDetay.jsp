                        ...
                        <div class="std">
                            <div class="meet-our-team">
                                <div class="about-item">
                                    <div class="row">
                                        ...
                                        <div class="right-item col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                            <div class="inner-box-">
                                                <%
                                                    ResultSet detay = db.baglan().executeQuery("SELECT *from duyurular WHERE duyuru_id = '" + request.getParameter("IDd") + "'");
                                                    if (detay.next()) {
                                                        out.print((detay.getString("duyuru_detay")).replace("/**/", "'"));
                                                    }
                                                %>
                                            </div>
                                        </div>
                                ...
                                <div class="row main-team">
                                    <div class="box-staff col-lg-3 col-xs-6 equal-height"><img class="img-responsive" alt="" src="http://mt-quartz02.magentothemes.net/media/wysiwyg/magenthemes/static/staff1.jpg">
                                        <div class="info-staff">
                                            <h5 class="staff-name">LOGAN DICKY</h5>
                                            <p>CEO &amp; Co-Founder</p>
                                    ...
                                    <div class="box-staff col-lg-3 col-xs-6 equal-height"><img class="img-responsive" alt="" src="http://mt-quartz02.magentothemes.net/media/wysiwyg/magenthemes/static/staff2.jpg">
                                        <div class="info-staff">
                                            <h5 class="staff-name">JEREMY DUPONT</h5>
                                            <p>Co-Founder</p>
                                            <ul class="social-icons small light">
                                                <li class="facebook"><a href="http://www.facebook.com/" target="_blank"><i class="fa fa-facebook"><span>Facebook</span></i></a></li>
                                                <li class="twitter"><a href="http://www.twitter.com/" target="_blank"><i class="fa fa-twitter"><span>Twitter</span></i></a></li>
                                    ...
                                    <div class="box-staff col-lg-3 col-xs-6 equal-height"><img class="img-responsive" alt="" src="http://mt-quartz02.magentothemes.net/media/wysiwyg/magenthemes/static/staff3.jpg">
                                        <div class="info-staff">
                                            <h5 class="staff-name">BRYAN JHONSON</h5>
                                            <p>Developer</p>
                                            <ul class="social-icons small light">
                                                <li class="facebook"><a href="http://www.facebook.com/" target="_blank"><i class="fa fa-facebook"><span>Facebook</span></i></a></li>
                                                <li class="twitter"><a href="http://www.twitter.com/" target="_blank"><i class="fa fa-twitter"><span>Twitter</span></i></a></li>
                                    ...
                                    <div class="box-staff col-lg-3 col-xs-6 equal-height"><img class="img-responsive" alt="" src="http://mt-quartz02.magentothemes.net/media/wysiwyg/magenthemes/static/staff4.jpg">
                                        <div class="info-staff">
                                            <h5 class="staff-name">MARIANE SMITH</h5>
                                            <p>Developer</p>
                                            <ul class="social-icons small light">
                                                <li class="facebook"><a href="http://www.facebook.com/" target="_blank"><i class="fa fa-facebook"><span>Facebook</span></i></a></li>
                                                <li class="twitter"><a href="http://www.twitter.com/" target="_blank"><i class="fa fa-twitter"><span>Twitter</span></i></a></li>
